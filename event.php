<?php
	...
	$query="INSERT INTO `createevent`(`Eventname`, `college`, `date`, `time`) VALUES ('$Eventname','$college','$date','$time')";
	$run=mysqli_query($con,$query);

	if($run==true)
	{
		echo "<script>alert('Evente Submited');</script>";
	}
	else {
		
		echo "<script>alert('Evente Not Submited');</script>";
	}
